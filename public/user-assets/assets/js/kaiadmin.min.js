...
$(document).ready(function() {
    ...
    $(".nav-item a").on("click", function() {
        const st = $(this).attr("side-menu") ? $(this).attr("side-menu") : true;
        console.log(st,"st");
        $(this).attr("side-menu",(st == "false" ? "true" : "false"));

        $(this).parent().find(".collapse").hasClass("show") ? $(this).parent().removeClass("submenu") : $(this).parent().addClass("submenu");
        
        if($(this).attr("side-menu") == "true"){
            //alert(34);
            setTimeout(()=>{ 
            ...
            if($(this).hasClass("dropdown-toggle")) {
                $(this).next("ul").removeClass("fadeIn").addClass("d-block");
            }
        } else{
            if($(this).hasClass("dropdown-toggle")) {
                $(this).next("ul").removeClass("d-block");
            }
        }  
    }),
