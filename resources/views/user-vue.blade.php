...
<head>
    ...
    <link rel="icon" href="{{ asset('user-assets/assets/img/kaiadmin/favicon.ico') }}" type="image/x-icon" />
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ asset('user-assets/assets/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('user-assets/assets/css/plugins.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('user-assets/assets/css/kaiadmin.min.css') }}" />
